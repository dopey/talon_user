...
keymap = {
    ...
    '(left | crimp)': Key('left'),
    '(left | crimp) 2': [Key('left'), Key('left')],
    '(left | crimp) 3': [Key('left'), Key('left'), Key('left')],
    '(left | crimp) 4': [Key('left'), Key('left'), Key('left'), Key('left')],
    '(left | crimp) 5': [Key('left'), Key('left'), Key('left'), Key('left'), Key('left')],
    '(right | chris)': Key('right'),
    '(right | chris) 2': [Key('right'), Key('right')],
    '(right | chris) 3': [Key('right'), Key('right'), Key('right')],
    '(right | chris) 4': [Key('right'), Key('right'), Key('right'), Key('right')],
    '(right | chris) 5': [Key('right'), Key('right'), Key('right'), Key('right'), Key('right')],
    '(up | jeep)': Key('up'),
