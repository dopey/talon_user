...
keymap = {
    ...
    'fish': Key('ctrl-right'),
    'ricky': Key('cmd-right'),
    'ricky two': [Key('cmd-right'), Key('cmd-right')],
    'ricky three': [Key('cmd-right'), Key('cmd-right'), Key('cmd-right')],
    'ricky four': [Key('cmd-right'), Key('cmd-right'), Key('cmd-right'), Key('cmd-right')],
    'lefty': Key('cmd-left'),
    'lefty two': [Key('cmd-left'), Key('cmd-left')],
    'lefty three': [Key('cmd-left'), Key('cmd-left'), Key('cmd-left')],
    'lefty four': [Key('cmd-left'), Key('cmd-left'), Key('cmd-left'), Key('cmd-left')],
    '(left | crimp)': Key('left'),
